...
**Wave 1**
  ...
  - [x] 08-01-PLAN.md — FINDING-06 cleanup: remove the orphaned "CLI Command" field + `cliCommandKey` from MenuView/AppState (D-01/D-01a); add `instructionsKey` (SETTINGS-05)
