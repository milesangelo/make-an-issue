# Requirements Archive: v1.1 Concurrent Filing & Control
...
- **Validated as delivered:** 15/15 requirements.
- **Clarified during UAT:** CANCEL-02's "removes the job" means removal from the in-flight set;
  the terminal `.cancelled` row remains visible until the user dismisses it.
- **Adjusted or dropped:** none.
