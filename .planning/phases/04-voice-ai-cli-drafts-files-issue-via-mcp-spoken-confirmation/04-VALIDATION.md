...
| Property | Value |
|----------|-------|
| **Framework** | {swift-testing / XCTest — confirm from RESEARCH ## Validation Architecture} |
...
- [ ] `{Tests/MakeAnIssueTests/...}` — stubs for the phase requirements
- [ ] `{shared fixtures / sample JSONL stdout from spike 002}`
